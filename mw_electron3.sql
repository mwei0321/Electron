...
Source Server         : phpython
Source Server Version : 50622
Source Host           : phpython.gotoftp3.com:3306
Source Database       : phpython

Target Server Type    : MYSQL
Target Server Version : 50622
File Encoding         : 65001

Date: 2017-03-13 17:14:20
*/
...
CREATE TABLE `article` (
  ...
  `uid` int(11) unsigned DEFAULT '1' COMMENT '用户ID',
  `cateid` int(11) unsigned DEFAULT '1' COMMENT '分类ID',
  ...
  `author` int(11) DEFAULT '1' COMMENT '作者ID',
  ...
  KEY `category` (`cateid`),
  KEY `tag` (`tags`)
) ENGINE=MyISAM AUTO_INCREMENT=78 DEFAULT CHARSET=utf8 COMMENT='文章表';
...
INSERT INTO `article` VALUES ('10', '0', '23', '13', '1', 'Linux配置`.bashrc`,  `vim`， Linux配置命令缩写', '1', '627', '0', 'Linux配置`.bashrc`,  `vim`  Linux配置命令缩写', '1468835805', '1371907485');
...
INSERT INTO `article` VALUES ('14', '1', '21', '21', '0', 'python各种类型转换-int,str,char,float,ord,hex,oct等', '1', '6', '0', 'python各种类型转换-int,str,char,float,ord,hex,oct等 ', '1372762175', '1372761865');
...
INSERT INTO `article` VALUES ('20', '1', '20', '19', '0', 'php 文件下载详解', '1', '11', '0', 'php 文件下载详解', '1375523177', '1375523177');
...
INSERT INTO `article` VALUES ('32', '1', '21', '22,21', '1', 'django url 详解 - Python Django  学习笔记4', '1', '822', '0', 'django的url配置、用法。', '1488791216', '1382521106');
...
INSERT INTO `article` VALUES ('35', '1', '21', '16,21,22', '1', 'django模型详解之模型创建 － Python Django 学习笔记6', '1', '452', '0', '新建模型，模型语法', '1488791216', '1385174807');
INSERT INTO `article` VALUES ('36', '1', '21', '21,22', '0', 'django模型详解之数据库操作 － Python Django 学习笔记7', '1', '16', '0', '', '1389189068', '1385279767');
...
INSERT INTO `article` VALUES ('38', '1', '21', '21', '1', 'python的string类里面的函数列表和解释', '1', '4', '0', 'python的string类里面的函数列表和解释.python的字符串常用函数.', '1488791216', '1488512444');
INSERT INTO `article` VALUES ('39', '1', '21', '21', '1', 'python的一些常用的函数', '1', '0', '0', '介绍一些python的常用的函数,如: index,in,extend,append,insert等式', '1488791216', '1488791216');
INSERT INTO `article` VALUES ('40', '1', '21', '21,22', '1', 'django request的属性，用法', '1', '0', '0', 'django request的属性，用法', '1488791216', '1488791216');
INSERT INTO `article` VALUES ('42', '1', '33', '26', '1', 'mongodb如何安装', '1', '0', '0', 'mongodb如何安装', '1488791216', '1381134321');
INSERT INTO `article` VALUES ('44', '1', '38', '15', '1', 'git客户端详细配置', '1', '0', '0', 'git客户端详细配置', '1488791216', '1381134321');
INSERT INTO `article` VALUES ('45', '1', '20', '19', '1', 'curl_init()函数不可用', '1', '0', '0', 'curl_init()函数不可用', '1488791216', '1381134321');
INSERT INTO `article` VALUES ('46', '1', '29', '16', '1', 'mysql如何把一表的某个字体更新到另一表的相同字段', '1', '0', '0', 'mysql如何把一表的某个字体更新到另一表的相同字段', '1488791216', '1381134321');
INSERT INTO `article` VALUES ('47', '0', '31', null, '1', 'wamp5下的虚拟主机的配置', '1', '2', '0', 'wamp5下的虚拟主机的配置', '1488882360', '1381134321');
INSERT INTO `article` VALUES ('48', '1', '23', '13,17', '1', 'scp命令把本地的文件或文件夹复制到远端', '1', '0', '0', 'scp命令把本地的文件或文件夹复制到远端', '1488791216', '1381134321');
INSERT INTO `article` VALUES ('49', '1', '28', '18', '1', 'js验证如何限制输入框input只能输入数字,字母，等的正则表达式。', '1', '0', '0', 'js验证如何限制输入框input只能输入数字,字母，等的正则表达式。', '1488791216', '1381134321');
INSERT INTO `article` VALUES ('50', '1', '28', '18', '1', 'jquery自定义扩展函数', '1', '0', '0', '如何在jquery自定义扩展函数', '1488791216', '1381134321');
INSERT INTO `article` VALUES ('51', '1', '28', '18', '1', 'jquery获取元素离顶部的高度', '1', '0', '0', 'jquery获取元素离顶部的高度', '1488791216', '1381134321');
INSERT INTO `article` VALUES ('52', '1', '25', '18,11', '1', 'html5做一个表的动画特效', '1', '1', '0', 'html5做一个表的动画特效', '1488791216', '1381134321');
INSERT INTO `article` VALUES ('53', '1', '38', '15', '1', 'git在服务器的配置', '1', '0', '0', 'git在服务器的配置', '1488791216', '1381134321');
INSERT INTO `article` VALUES ('54', '1', '28', '11,18', '1', '图片传前预览', '1', '0', '0', '在图片传前预览你的图片', '1488791216', '1381134321');
INSERT INTO `article` VALUES ('55', '1', '28', '11,18', '1', 'jquery获取选中的文字', '1', '0', '0', 'jquery获取选中的文字', '1488791216', '1381134321');
INSERT INTO `article` VALUES ('56', '1', '20', null, '1', 'Fatal error: Unsupported operand types', '1', '0', '0', 'Fatal error: Unsupported operand types', '1488791216', '1381134321');
INSERT INTO `article` VALUES ('57', '1', '20', '19', '1', 'php如何生成真正的静态文件', '1', '0', '0', 'php如何生成真正的静态文件', '1488791216', '1381134321');
INSERT INTO `article` VALUES ('58', '1', '28', '18', '1', 'jquery判断密码强度', '1', '0', '0', 'jquery判断密码强度', '1488791216', '1381134321');
INSERT INTO `article` VALUES ('59', '1', '21', '21', '1', 'python文件操作函数', '1', '0', '0', 'python文件操作函数', '1488791216', '1381134321');
INSERT INTO `article` VALUES ('60', '1', '20', '19', '1', 'php获取文件扩展名', '1', '0', '0', 'php中如何获取文件中的扩展名', '1488791216', '1381134321');
INSERT INTO `article` VALUES ('61', '1', '20', '19', '1', 'php循环创建文件夹', '1', '0', '0', 'php如何循环创建文件夹的方法', '1488791216', '1381134321');
INSERT INTO `article` VALUES ('62', '1', '20', '19', '1', 'php从网络上下载图片并保存', '1', '0', '0', 'php从网络上下载图片，并保存，用php把远端的图片下载到本地。', '1488791216', '1381134321');
INSERT INTO `article` VALUES ('63', '1', '20', '19', '1', 'php如何发送http请求并且返回结果', '1', '0', '0', 'php如何发送http请求并且返回结果', '1488791216', '1381134321');
INSERT INTO `article` VALUES ('65', '1', '20', '19', '1', '正则匹配网址', '1', '0', '0', '如何用正则匹配网址，匹配网址的正则表达式。', '1488791216', '1381134321');
INSERT INTO `article` VALUES ('64', '1', '21', '21,22', '1', 'django模板标签。', '1', '0', '0', '在学习django模板的时候 ，不能不学习模板标签，模板标签是模板的核心，下面看一个都有那些模板标签。', '1488791216', '1381134321');
INSERT INTO `article` VALUES ('66', '1', '20', '19', '1', 'php短网址功能如何实现', '1', '0', '0', 'php短网址功能如何实现', '1488791216', '1381134321');
INSERT INTO `article` VALUES ('67', '1', '23', '17', '0', 'debian常用命令', '1', '0', '0', 'debian常用命令，pwd', '1488791216', '1381134321');
INSERT INTO `article` VALUES ('68', '1', '37', null, '1', 'ps常用快捷键', '1', '0', '0', 'ps常用快捷键', '1488791216', '1381134321');
INSERT INTO `article` VALUES ('69', '1', '4', '16', '1', 'mysql root 忘记密码', '1', '0', '0', '如果你忘记mysql root密码', '1488791216', '1381134321');
INSERT INTO `article` VALUES ('70', '1', '23', '17,13', '1', '修改crontab修改默认编辑器方法', '1', '0', '0', '修改crontab的默认编辑器方法。', '1488791216', '1381134321');
INSERT INTO `article` VALUES ('71', '1', '23', '17,13', '1', 'linux计划任务', '1', '0', '0', 'linux计划任务的命令相关的详细解释', '1488791216', '1381134321');
INSERT INTO `article` VALUES ('72', '1', '20', '17,19', '1', 'php安装rar模块', '1', '1', '0', 'php安装rar', '1488791216', '1381134321');
INSERT INTO `article` VALUES ('73', '0', '36', null, '1', '三极管基础认识', '1', '0', '0', '三极管', '1488960697', '1488942727');
INSERT INTO `article` VALUES ('74', '0', '36', null, '1', '555芯片认识介绍', '1', '9', '0', 'NE555,555时基电路，555IC', '1489128759', '1489028850');
INSERT INTO `article` VALUES ('75', '0', '36', null, '1', '555闪光电路原理', '1', '7', '0', '555时基电路，555闪光电路', '1489288271', '1489128747');
INSERT INTO `article` VALUES ('76', '0', '36', null, '1', 'NE555振荡电路原理', '1', '2', '0', 'NE555振荡电路原理', '1489288310', '1489229544');
INSERT INTO `article` VALUES ('77', '0', '34', null, '1', 'DS18B20程序', '1', '0', '0', '51 DS18B20程序例程', '1489315546', '1489315535');
...
INSERT INTO `article_category` VALUES ('5', '0', '电子电路', '1', null, '0');
INSERT INTO `article_category` VALUES ('35', '5', 'STM32', '1', 'ARM核心', '0');
...
INSERT INTO `article_category` VALUES ('31', '3', 'Lnmpa', '1', 'Linux+Nginx+PHP+MySql+Apache是一个绝配啊！', '70');
...
INSERT INTO `article_category` VALUES ('30', '4', 'Redis', '1', '', '0');
INSERT INTO `article_category` VALUES ('34', '5', '51-STC', '1', '', null);
INSERT INTO `article_category` VALUES ('36', '5', '电子基础', '1', '电子电路基础知识', null);
INSERT INTO `article_category` VALUES ('37', '0', '其它', '1', '杂项', null);
INSERT INTO `article_category` VALUES ('38', '3', 'Git', '1', 'git版本控制', null);
...
INSERT INTO `article_content` VALUES ('47', 'wamp5下的虚拟主机的配置，wamp5如何配置虚拟主机。', '<h2 style=\"text-align:center;\">&nbsp; &nbsp;\r\n	wamp5虚拟主机的配置</h2><p><br/></p><p>wamp5虚拟主机的配置如下：</p><p>1.首先打你安装目录下的Apache配置文件C:\\wamp\\bin\\apache\\apache2.2.22\\conf\\htttpd.conf ,在里面查找</p><p><span style=\"color: rgb(227, 108, 9);\">#Include conf/extra/httpd-vhosts.conf</span></p><p>找到后把前面的 ‘‘#’’号去掉。</p><p>2.在Apache配置目录里面找到C:\\wamp\\bin\\apache\\apache2.2.22\\conf\\extra\\httpd-vhosts.conf, 把里面的所有删除，然后在里面添加如下的内容：</p><pre class=\"language-bash\"><code class=\"language-bash\">&lt;VirtualHost *:80&gt;<br/> &nbsp; &nbsp;DocumentRoot &quot;D:/web/test&quot;<br/> &nbsp; &nbsp;ServerName www.t.com<br/> &nbsp; &nbsp;ServerAlias t.com<br/>&lt;/VirtualHost&gt;<br/></code></pre><p>需要多个就复制多个。</p><p>4.然后在host文件里面加上域名就可以了。<br/></p>');
INSERT INTO `article_content` VALUES ('73', '三极管基础，三极启动电压', '<p><strong>1.认识三极管</strong> &nbsp; &nbsp;</p><p><span style=\"font-size: 12px;\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;三极管做为一个常用，也是很重要元件，在电路上不可缺少的。常用的三极管根据材料分有硅管和锗管两种，原理都相同，只是压降略不同，而这两种硅管用的比较多，而三极管按类型分，也分为两种：PNP 和&nbsp;NPN型，如下图：</span></p><p style=\"text-align:center\"><img mwattach=\"/Uploads/editer/image/2017/2017030811265624551.png\" src=\"/Uploads/editer/image/2017/2017030811265624551.png\" title=\"2017030811265624551.png\" alt=\"2017030811265624551.png\"/></p><p><span style=\"font-size: 12px;\">&nbsp;三极管之所以叫三极管，是因为他有三个极，分别是左侧横向基极（base）标识号: b,有箭头端的发射极（emitter）标识号:e,剩下另一端为集电机c(collector)标识号:c。</span></p><p><strong><span style=\"font-size: 16px;\">2.三极管原理</span></strong></p><p><strong><span style=\"font-size: 16px;\">&nbsp;&nbsp;&nbsp;&nbsp;<span style=\"font-size: 12px;\"></span></span></strong><span style=\"font-size: 12px;\">三极管的工作原理其它就是他的三种工作状态：截止、放大、饱和。截止和饱和一般来用做开关，现在基本都是用这个特性。至于放大的特型现在很少人用了，在以前模拟电路中常用三极管做放大用，例如：功放板之类的。</span><strong><span style=\"font-size: 16px;\"><br/></span></strong></p><p><span style=\"font-size: 12px;\">&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;三极管的类型和用法总结如下口诀：</span><span style=\"color: rgb(255, 0, 0);\"><strong>箭头朝内 PNP ，导通电压顺箭头过，电压导通，电流控制。</strong></span></p><p><strong><span style=\"color:#ff0000\">&nbsp;&nbsp;&nbsp;&nbsp;<span style=\"font-size: 12px;\">&nbsp;</span></span></strong><span style=\"color:#ff0000\"><span style=\"font-size: 12px; color: rgb(0, 0, 0);\">其实现在基本上只要会用三极管开关控制特性就够了，至于放大特性还是去好好专业学习三极管，还涉及到各种计算，对于像我这种初级电子水平的人真搞不定。</span></span><strong style=\"color: rgb(255, 0, 0);\"><br/></strong></p><p><span style=\"color: rgb(0, 0, 0); font-size: 16px;\"><strong>3.三极管用法</strong></span><br/></p><p>&nbsp;&nbsp;&nbsp;&nbsp;<span style=\"font-size: 12px;\">三极管的作用：控制、驱动。在以前模拟电路中，大部份的作用是放大，特别早期的音箱中用的很多。还有就是用他的截止、饱和的特性，做为开关控制。<span style=\"font-size: 16px;\"><strong><span style=\"color: rgb(255, 0, 0);\">所以使用的时候只要注意箭头，只要箭头尾部端比箭头头端高0.7V以上就导通了。</span></strong></span></span></p><p><span style=\"font-size: 12px;\"><span style=\"font-size: 16px;\"><strong><span style=\"color: rgb(255, 0, 0);\">&nbsp;&nbsp;&nbsp;&nbsp;<span style=\"color: rgb(0, 0, 0); font-size: 12px;\"></span></span></strong><span style=\"color: rgb(255, 0, 0);\"><span style=\"color: rgb(0, 0, 0); font-size: 12px;\">比如PNP型的，发射极 e 比基极 b 的电压高0.7v以上那这个三极管就导通了，电流的方向了就是发射极流向集电极。基极就是控制开关。</span></span></span></span></p><p><span style=\"font-size: 12px;\">以上就是我对三极管的一些基础认识，以上也是我从网上学习来的，口诀也是我从《手把手教你学单片机》里摘录下来的。</span></p>');
...
INSERT INTO `article_content` VALUES ('74', 'NE555,555时基电路，555IC', '<p><span style=\"font-size: 14px;\"><strong>1. 555认识：</strong></span><br/></p><p><strong>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;</strong>1.0 555芯片由于内部电路串联了3个5K的电阻作为电压取样，所以叫555。&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1.1 555就是一种模拟和数字功能相结合在一起的集成电路IC芯片。</p><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1.2 工作电压范围宽：4.5v~16V都可以工作。驱动电流大概在200mA。<br/></p><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1.3 555常被用来做：延时开关、 振荡器、触发器等。<br/></p><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1.4 555引脚图：（找张实物图好难啊，找了很久才找到一个张贴片的，没有水印的，有水印的不敢用）</p><p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<img mwattach=\"/Uploads/editer/image/2017/2017030911253447488.png\" src=\"/Uploads/editer/image/2017/2017030911253447488.png\" title=\"2017030911253447488.png\" alt=\"2017030911253447488.png\"/>&nbsp; &nbsp; &nbsp; &nbsp;<img mwattach=\"/Uploads/editer/image/2017/2017030911302242846.png\" src=\"/Uploads/editer/image/2017/2017030911302242846.png\" title=\"2017030911302242846.png\" alt=\"2017030911302242846.png\"/></p><p><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;</strong><span style=\"font-size: 12px;\">引脚说明：&nbsp;&nbsp;&nbsp;&nbsp;</span></p><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Pin 1: 电源负极。<strong><br/></strong></p><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Pin 2: 触发入端，算是555时基电路中的开关。<span style=\"color: rgb(255, 0, 0);\"><strong>只要这个脚在电压低于电源电压的三分之一时，3脚就输出一个高电压，电压约等于Vcc&nbsp;- 1V左右。(Vcc为电源电压)，如果高出于三分之一时，3脚输出不变，保持之前的状态，也就说之前是高还是高，是低还是低。</strong></span><br/></p><p><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>Pin3: 输出端，这脚输出高低电压，高电压为 Vcc - 1V左右，低电压当然就为0V了。控制些脚高低电压是2脚和6脚决定。输出最大电流为芯片能输出最大电流，约为200mA,带几个发光LED,或者小电流外设还是可以，那如果驱动大电流外设，当配合驱动电路了啊。<strong><span style=\"color: rgb(255, 0, 0);\"><br/></span></strong></p><p><span style=\"color: rgb(255, 0, 0);\">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </span>Pin4: 复位重置，简单的说，就是他接到低电平时，不管2脚和6脚是什么情况，3脚都输出低电压。基本上很少用到，不接就可以了。</p><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Pin5: 电压控制，基本也很少用，它的作用是能控制3脚输出高低电平的频率。这个脚用的很少，基本悬空，就是什么都不接。5脚在555芯片内部的电压为2/3 VCC，有时候会用这个脚来影响6脚。当该端不用时，应将该端串入一只0.01μF电容接地，以防引入干扰。</p><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Pin6: 重置锁定, 此脚就是控制3脚输出低电平，就是0V。想要3脚输出低电平要满足两个条件：</p><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style=\"color: rgb(255, 0, 0);\">&nbsp;<strong>a) 6脚电压从1/3Vcc 升到 2/3Vcc以上。<br/></strong></span></p><p><strong><span style=\"color: rgb(255, 0, 0);\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;b) 2脚的电压要在1/3以上。</span></strong><br/></p><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Pin7:&nbsp;放电端。该端与放电管集电极相连，用做定时器时电容的放电。此脚的电压和3脚电压保持一致。当3脚高电压，7脚也是高电压。当3脚为低电压，7脚也是低电压。但是7脚无电流输出能力。也就是当7脚高电压的时候，他不能输出电流，也就是电流非常非常小。但是当7脚低电压的时候，他相当于负极，能给电容放电。</p><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Pin8: 电源正极，这个没有什么可说的了。<br/></p><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong><span style=\"color: rgb(255, 0, 0);\">总结一下：1负8正，接电源。2、6控制3输出。4脚重置7放电。</span></strong></p><p><strong><span style=\"color: rgb(255, 0, 0);\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;当2脚电压低于1/3 VCC，3脚输出高电平。当2脚接地的时候，3脚一定高电平输出，除非4脚也接地。这个时候，只要2脚电压升高到1/3 VCC以上，6脚的电压升高到2/3 VCC以上，那么3脚电压变成低电平，也就是0V。感觉这里有点复杂，实际应用的时候，2脚和6脚一般都是焊到一起，一起作为触发点。所以我们只要处理一种情况，触发点电压为低，输出为高；触发点电压为高，输出为低。</span></strong></p><p><br/></p><p style=\"text-align: right;\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; 本文章是参考网友@浅雪的《学会使用NE555》,非常感谢 浅雪大神无么奉献<br/></p>');
INSERT INTO `article_content` VALUES ('75', '讲解555的电路应用', '<p><strong><span style=\"font-size: 14px;\">1.555闪光电路原理：</span></strong></p><p><strong><span style=\"font-size: 14px;\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;</span></strong></p><p style=\"text-align:center\"><span style=\"font-size: 14px;\"><img mwattach=\"/Uploads/editer/image/2017/2017031015081979636.gif\" src=\"/Uploads/editer/image/2017/2017031015081979636.gif\" title=\"2017031015081979636.gif\" alt=\"2017031015081979636.gif\"/></span></p><p>555闪光电路典型电路图，本文将以此图讲解555应用原理。</p><p><span style=\"color: rgb(255, 0, 0);\"><strong>这个原理主要是电容 C1 充放电，让 2、6 的电压高低变化，控制 3 脚的高低电压输出。</strong></span><br/></p><p><span style=\"color: rgb(255, 0, 0);\"><strong><br/></strong></span></p><p>具体为析如下：</p><p>&nbsp;&nbsp;&nbsp;&nbsp;首先整个电路的电压在5v~10v之前，其实只要在555工作电压范围都行，这里我们假设Vcc的电压为6V。</p><p>&nbsp;&nbsp;&nbsp;&nbsp;在电路启动的时候，首先是 LED-D1亮，因为 C1 充电是需要时间，这个时间取绝于 R2、R3 和 C1 大小决定的。所以2脚的电压都还低于Vcc的三分之一，那么3脚输出的是高电平，也就是电压为Vcc-1V左右。LED-D2点亮。</p><p>&nbsp;&nbsp;&nbsp;&nbsp;随着C1的充电，电压升高，当2、6脚电压升到Vcc的三分之二以上的时候。3脚输出低电压。所以LED-D2关闭，LED-D1导通点亮。</p><p>C1充、放电就是LED交替点亮。就是闪烁电路的基本原理了。</p><p>&nbsp;&nbsp;&nbsp;&nbsp;闪烁的时间间隔为C1电容充电、放电时间。</p><p>&nbsp;&nbsp;&nbsp;&nbsp;如果不懂NE555的基本原理可以看上一篇教程是。<br/></p><p><br/></p><p><br/></p>');
INSERT INTO `article_content` VALUES ('77', '51 DS18B20程序例程', '');
INSERT INTO `article_content` VALUES ('76', 'NE555振荡电路原理', '<p><strong><span style=\"font-size: 14px;\">555振荡电路原理图一：</span></strong></p><p><strong><span style=\"font-size: 14px;\"><img mwattach=\"/Uploads/editer/image/2017/2017031120233016697.png\" src=\"/Uploads/editer/image/2017/2017031120233016697.png\" title=\"2017031120233016697.png\" alt=\"2017031120233016697.png\"/><br/></span></strong></p><p><span style=\"font-size: 12px;\">这已经是第三篇教程了。555的基本原理就不再说了，那直接说这张振荡电路的原理了。其实这个图还是跟上面那个闪光电路是一样的，也是2、6脚的高低电平控制3脚的输出高低电平。<br/></span></p><p><span style=\"font-size: 12px;\">其实上篇的闪光也是一个振荡器，只不过是频率特别低。我们所说的振荡器，一般都是频率比较高的，比例在1KHz以上的。</span></p><p><span style=\"font-size: 12px;\">如果上篇学的很透的话，这个电路也就明白了，就是C1充放电的时间非常短，短到一秒钟充、放电几千，几万，几十万次，就是一个高频振荡器。</span></p><p><span style=\"font-size: 12px;\">当然了，R1的电阻不要太小了，因为太小了，电流会很大，555芯片会烧掉。</span></p><p><span style=\"font-size: 12px;\">知道是什么原理不，因为3脚和7脚的电平状态是一样的。当3脚为低的时候，7脚也为低，所以电流会经过R1从7脚进入555芯片，所以555会因为进入7脚大电流烧掉。</span></p><p><span style=\"font-size: 12px;\">所以一般还是调节R2、C的大小，来控制555芯片。</span></p><p>如果是这个图，可以用下面的公式计算：<span style=\"font-size: 14px;\"><strong><span style=\"color: rgb(255, 0, 0);\"> T=0.7 x (R1 + 2 x R2) x C</span></strong></span><span style=\"color: rgb(255, 0, 0); font-size: 14px;\"></span></p><p>由于频率 F 等于周期的倒数，所以又等于 <span style=\"color: rgb(255, 0, 0);\"><strong><span style=\"font-size: 14px;\">F=1/T=1.43/[(R1+2R2)C]，注意的是 C 的单位是 F(法拉)，1F = 1 x 10^6uF = 1 x 10^9nF = 1 x 10^12pF<br/></span></strong></span></p><p>为了振荡器的稳定，一般在脚接一个0.0uF的电容到地。<br/></p><p style=\"text-align: right;\">以上内容参考@浅雪的《学会使用NE555》<br/></p>');
...
-- ----------------------------
INSERT INTO `article_tag` VALUES ('11', '2', 'HTML', '', '50', '1');
INSERT INTO `article_tag` VALUES ('12', '2', 'CSS', '', '50', '1');
